  ...
  return (
    <div className="flex mt-[114px] gap-[105px] max-w-[1111px] mx-auto">
      <div className="py-3 max-w-[594px] w-full">
        ...
        {BannerData?.content?.btns?.length > 0 && <div className="flex gap-[10px]">
      ...
      {BannerData?.images?.length > 0 && <div className="flex relative max-w-[411px] w-full">
